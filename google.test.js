...
test('I can search Google', async () => {
    ...
    searchBar = await driver.findElement(By.xpath('//div/input'))

    // We'll use this line to clear out our old input.
    await driver.findElement(By.xpath('//div/input')).clear() 

    // Let's do another search!
    await driver.findElement(By.xpath('//div/input')).sendKeys('Trans Pride Flag\n')
